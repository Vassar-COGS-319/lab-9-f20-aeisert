...
# PARAMETERS
tau <- 1 # Higher values will mean that activations are stronger for highly similar items in memory.
         # Lower values spread out the activation more, so loosely similar items are somewhat activated.
lossy.encoding <- .99 # proportion of features to KEEP when encoding.
